...
CREATE TABLE `sellers` (
  ...
  PRIMARY KEY (`UserID`,`USER_TYPE`),
  KEY `UserID_idx` (`UserID`),
  CONSTRAINT `sellers_chk_1` CHECK ((`USER_TYPE` = _utf8mb3'B')) /*!80016 NOT ENFORCED */,
  CONSTRAINT `sellers_chk_2` CHECK ((`USER_TYPE` = _utf8mb3'S')),
  CONSTRAINT `sellers_chk_3` CHECK ((`USER_TYPE` = _utf8mb3'B')) /*!80016 NOT ENFORCED */,
  CONSTRAINT `sellers_chk_4` CHECK ((`USER_TYPE` = _utf8mb3'S'))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
